...
// Defining the class Task with its attributes
class Task {
    int taskId;
    String taskName;
    String status;
...
class SinglyLinkedList {
    ...
    // Method to add the task to node list
    ...
    // Method to search task by taskId
...
public class TaskManager {
    public static void main(String[] args) {
        ...
        // Traverse the list after deleting the task
